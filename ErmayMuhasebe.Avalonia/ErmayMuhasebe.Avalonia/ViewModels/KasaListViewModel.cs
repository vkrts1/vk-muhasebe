...
public partial class KasaListViewModel : ErmayMuhasebe.Shared.ViewModels.KasaListViewModel
{

    public KasaListViewModel(IUnitOfWork uow, IPdfService pdfService) : base(uow, pdfService)
    {
        WeakReferenceMessenger.Default.Register<FinancialDataChangedMessage>(this, (r, m) => _ = LoadKasalarAsync());
    }
    ...
    public override void NavigateToDetay(BankaKart? kasa)
    {
        if (kasa == null) kasa = SelectedKasa;
        base.NavigateToDetay(kasa);
    }
}
