...
public partial class KasaListViewModel : ErmayMuhasebe.Shared.ViewModels.KasaListViewModel
{
    ...
    public KasaListViewModel(IUnitOfWork uow, PdfService pdfService, ErmayMuhasebe.Cloud.Services.IFileService fileService, NavigationManager navigationManager) 
        : base(uow, pdfService)
    {
